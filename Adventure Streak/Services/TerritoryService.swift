...
class TerritoryService {
    ...
    func processActivity(_ activity: ActivitySession, ownerUserId: String? = nil, ownerDisplayName: String? = nil) async -> (cells: [TerritoryCell], stats: TerritoryStats, events: [TerritoryEvent]) {
        ...
        let emptyStats = TerritoryStats(newCellsCount: 0, defendedCellsCount: 0, recapturedCellsCount: 0, stolenCellsCount: 0, totalLootXP: 0, totalConsolidationXP: 0, totalStreakInterruptionXP: 0)
        return ([], emptyStats, [])
    }
    ...
    func processActivities(_ activities: [ActivitySession], ownerUserId: String? = nil, ownerDisplayName: String? = nil) async -> TerritoryStats {
        ...
        return TerritoryStats(newCellsCount: 0, defendedCellsCount: 0, recapturedCellsCount: 0, stolenCellsCount: 0, totalLootXP: 0, totalConsolidationXP: 0, totalStreakInterruptionXP: 0)
    }
