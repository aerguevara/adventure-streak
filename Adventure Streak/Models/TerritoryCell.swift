...
struct TerritoryCell: Identifiable, Codable, Hashable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, centerLatitude, centerLongitude, boundary, lastConqueredAt, expiresAt
    }
    ...
    init(id: String, centerLatitude: Double, centerLongitude: Double, boundary: [TerritoryPoint], lastConqueredAt: Date, expiresAt: Date) {
        self.id = id
